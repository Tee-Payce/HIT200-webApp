...
const postData = ()=>{
   AuthService.register({fname,sname,studentID,password}).then(
   ...
   return (
    ...
    <Form  >
        ...
        <Form.Control onChange={(e)=>setFname(e.target.value)} className='bg-light' type="text" placeholder="Enter your first name" aria-required />
      </Form.Group>
      <Form.Group className="row mb-3" controlId="formBasicSurname">
        <Form.Label  className='text-dark'>Surname</Form.Label>
        <Form.Control onChange={(e)=>setSname(e.target.value)} className='bg-light' type="text" placeholder="Enter your surname" required />
      </Form.Group>
    <Form.Group className="row mb-3" controlId="formBasicID">
      ...
      <Form.Group className="row mb-3" controlId="formBasicPassword">
        ...
        <Form.Control onChange={(e)=>setPassword(e.target.value)} className='bg-light' type="password" placeholder="Re-enter Password" aria-required />
      </Form.Group>
